...
interface Stage4PostureSelectionProps {
  onBack: () => void;
  onStartPractice: (selectedPosture: string) => void;
}

const Stage4PostureSelection: React.FC<Stage4PostureSelectionProps> = ({
  onBack,
  onStartPractice
}) => {
  ...
  return (
    <div className="posture-selection">
      <div className="posture-selection-header">
        ...
        <h1>PAHM Practitioner Practice Setup</h1>
      </div>
      
      <div className="posture-selection-content">
        <h2>Select Your Posture</h2>
        <p className="instruction-text">
          Choose the posture you'll be using for this PAHM Practitioner practice session.
...
export default Stage4PostureSelection;
