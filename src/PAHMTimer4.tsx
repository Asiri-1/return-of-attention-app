...
const PAHMTimer4: React.FC<PAHMTimer4Props> = ({ 
  ...
  // Timer completion handler - EXACT same logic as PAHMTimer2 but Stage 4
  const handleTimerComplete = useCallback(() => {
    // Helper functions - same as PAHMTimer2
    ...
    const calculateSessionQuality = (counts: typeof pahmCounts, duration: number, completed: boolean) => {
      ...
      let quality = 7.5; // Stage 4 baseline
    ...
    // Data conversion - same as PAHMTimer2
    ...
    const sessionData = {
      ...
      stageLevel: 4, // Only difference from PAHMTimer2
    ...
    // Add emotional note - Stage 4 specific messaging
    ...
    // Navigation - EXACT same pattern as PAHMTimer2
  ...
  const handleStart = () => {
    if (initialMinutes < 30) { // Stage 4 minimum duration
  ...
  // Development fast-forward - same as PAHMTimer2
      ...
      <div style={{
        ...
        <div style={{
          ...
          <ul style={{ textAlign: 'left', marginTop: '10px' }}>
            ...
            <li><strong>Duration:</strong> Extended sessions (45+ minutes recommended)</li>
          </ul>
        </div>
      </div>
    );
  ...
  return (
    <div style={{
      ...
      {/* 3×3 PAHM Matrix - EXACT same as PAHMTimer2 */}
      <div style={{
        display: 'grid',
