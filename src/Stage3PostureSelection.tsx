...
interface Stage3PostureSelectionProps {
  onBack: () => void;
  onStartPractice: (selectedPosture: string) => void;
}

const Stage3PostureSelection: React.FC<Stage3PostureSelectionProps> = ({
  onBack,
  onStartPractice
}) => {
  ...
  return (
    <div className="posture-selection">
      <div className="posture-selection-header">
        ...
        <h1>PAHM Beginner Practice Setup</h1>
      </div>
      
      <div className="posture-selection-content">
        <h2>Select Your Posture</h2>
        <p className="instruction-text">
          Choose the posture you'll be using for this PAHM Beginner practice session.
...
export default Stage3PostureSelection;
